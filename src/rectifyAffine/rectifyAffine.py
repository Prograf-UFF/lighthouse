...
class RectifyAffine:
    ...
    def matrix_h(self):
        ...
        A = [[], [], [], [],[],[]]
        A[0] = [c_[0], c_[1], c_[2], 0, 0, 0, 0]
        A[1] = [0 , 0, 0, c_[0], c_[1], c_[2], 0]

        A[2] = [d_[0], d_[1], d_[2], 0, 0, 0, -(limit_x_-1)]
        A[3] = [0, 0, 0, d_[0], d_[1], d_[2], 0]

        A[4] = [e_[0], e_[1], e_[2], 0, 0, 0, 0]
        A[5] = [0, 0, 0, e_[0], e_[1], e_[2], -(limit_y_-1)]
        print_array("A", A)
